...
setup(
    name=name,
    version="0.0.1",
    description="Summarize, chat, and retrieve data from large repositories of documents.",
    long_description=long_description,
    long_description_content_type="text/markdown",
    author="Connor Gibbs",
    author_email="congibbs10@gmail.com",
    url="https://github.com/ConGibbs10/{}".format(name),
    license="MIT",
    packages=[name],
    package_data={name: ["data/chatterdocs.yml", "data/index.html"]},
    entry_points={
        "console_scripts": [
